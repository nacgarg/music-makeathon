...
//==============================================================================
const String MusicmakeathonAudioProcessor::getName() const
{
...
double MusicmakeathonAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
...
int MusicmakeathonAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
const String MusicmakeathonAudioProcessor::getProgramName (int index)
{
    return {};
}
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool MusicmakeathonAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void MusicmakeathonAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
void MusicmakeathonAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
